...
void PrintCore(std::stack<BinaryTreeNode*>& m_stack1, std::stack<BinaryTreeNode*>& m_stack2, bool fromRightToLeft)
{
	while (!m_stack1.empty())
	{
		std::cout << m_stack1.top()->m_nValue << " ";
		BinaryTreeNode* pLeft = m_stack1.top()->m_pLeft;
		BinaryTreeNode* pRight = m_stack1.top()->m_pRight;
...
void Print(BinaryTreeNode* pRoot)
{
	...
	std::stack<BinaryTreeNode*> m_stack1;
	std::stack<BinaryTreeNode*> m_stack2;
	m_stack1.push(pRoot);

	bool fromRightToLeft = true;

	while (!m_stack1.empty() || !m_stack2.empty())
	{
		if (fromRightToLeft)
		{
			PrintCore(m_stack1, m_stack2, fromRightToLeft);
			fromRightToLeft = false;
		}
		else
		{
			PrintCore(m_stack2, m_stack1, fromRightToLeft);
